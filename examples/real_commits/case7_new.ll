; ModuleID = 'examples/real_commits/case7_new.c'
source_filename = "examples/real_commits/case7_new.c"
target datalayout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "arm64-apple-macosx26.0.0"

; Function Attrs: mustprogress nofree norecurse nosync nounwind ssp willreturn memory(none) uwtable(sync)
define i32 @hash(i32 noundef %a, i32 noundef %b, i32 noundef %c) local_unnamed_addr #0 {
entry:
  %mul = mul i32 %a, -1640531535
  %add = add nsw i32 %mul, %b
  %mul3 = mul i32 %add, -2048144777
  %add5 = add nsw i32 %mul3, %c
  %mul7 = mul i32 %add5, -1028477379
  %0 = xor i32 %mul, %mul7
  %xor9 = xor i32 %0, %mul3
  ret i32 %xor9
}
