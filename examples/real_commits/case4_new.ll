; ModuleID = 'examples/real_commits/case4_new.c'
source_filename = "examples/real_commits/case4_new.c"
...
define i32 @dot(ptr noundef readonly captures(none) %a, ptr noundef readonly captures(none) %b) local_unnamed_addr #0 {
entry:
  %0 = load <4 x i32>, ptr %a, align 4, !tbaa !6
  %1 = load <4 x i32>, ptr %b, align 4, !tbaa !6
